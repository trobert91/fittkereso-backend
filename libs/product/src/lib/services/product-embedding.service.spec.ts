...
import type { AiEmbeddingService } from "@ebike-backend/ai";
import { ProductEmbeddingService } from "./product-embedding.service";

jest.mock("@ebike-backend/ai", () => ({
...
describe("ProductEmbeddingService", () => {
  ...
  beforeEach(async () => {
    ...
    const { AiEmbeddingService: MockedEmbeddingService } =
      jest.requireMock("@ebike-backend/ai");
