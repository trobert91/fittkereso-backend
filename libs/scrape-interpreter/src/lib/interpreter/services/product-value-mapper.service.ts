...
// Moved from libs/product-scraper as part of the declarative-scraping
// migration — its only remaining caller is the interpreter's mapSpecValue op
// (value-map-ops.ts). Logic unchanged.
@Injectable()
